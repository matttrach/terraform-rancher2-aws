...
## [3.1.5](https://github.com/matttrach/terraform-rancher2-aws/compare/v3.1.4...v3.1.5) (2026-09-22)


### Bug Fixes

* add agentic framework ([#169](https://github.com/matttrach/terraform-rancher2-aws/issues/169)) ([f6f8024](https://github.com/matttrach/terraform-rancher2-aws/commit/f6f8024e361ed7be74f2d23903cd8427a8d2435f))
* add long-lived plans and clean up legacy files ([#189](https://github.com/matttrach/terraform-rancher2-aws/issues/189)) ([2e2ad36](https://github.com/matttrach/terraform-rancher2-aws/commit/2e2ad36e87bee756fd8f3d08a0defb420c8111d3))
* add operational developer helper scripts and tools ([#188](https://github.com/matttrach/terraform-rancher2-aws/issues/188)) ([cdf9ccf](https://github.com/matttrach/terraform-rancher2-aws/commit/cdf9ccf2d9deab9d73eaf4b1d526c4400af42734))
* add workflow container and add or update plans and instructions ([#170](https://github.com/matttrach/terraform-rancher2-aws/issues/170)) ([b0b7730](https://github.com/matttrach/terraform-rancher2-aws/commit/b0b7730eb42bef5bebf78a7b0dbe24fc62905412))
* bump actions/checkout from 6.0.2 to 6.0.3 ([#163](https://github.com/matttrach/terraform-rancher2-aws/issues/163)) ([6f0cbc7](https://github.com/matttrach/terraform-rancher2-aws/commit/6f0cbc7643e17ccf93bfef6b37e1cac768135553))
* bump actions/checkout from 6.0.3 to 7.0.0 ([#166](https://github.com/matttrach/terraform-rancher2-aws/issues/166)) ([c7626e0](https://github.com/matttrach/terraform-rancher2-aws/commit/c7626e0e20ccd75df3bff30179295d75f8c4e453))
* bump actions/checkout from 7.0.0 to 7.0.1 ([#183](https://github.com/matttrach/terraform-rancher2-aws/issues/183)) ([dc9870f](https://github.com/matttrach/terraform-rancher2-aws/commit/dc9870f150e3d696346f7edc2d4585314c127b09))
* bump aws-actions/configure-aws-credentials from 6.1.1 to 6.2.0 ([#164](https://github.com/matttrach/terraform-rancher2-aws/issues/164)) ([939d6eb](https://github.com/matttrach/terraform-rancher2-aws/commit/939d6eb9532a47d6b7b3f0ba394001bf8e9f55bc))
* bump aws-actions/configure-aws-credentials from 6.2.0 to 6.2.1 ([#167](https://github.com/matttrach/terraform-rancher2-aws/issues/167)) ([7c529a1](https://github.com/matttrach/terraform-rancher2-aws/commit/7c529a19c5f4b5436ef4cee6d64c01f0523b202b))
* bump aws-actions/configure-aws-credentials from 6.2.1 to 6.2.2 ([#173](https://github.com/matttrach/terraform-rancher2-aws/issues/173)) ([7b5c454](https://github.com/matttrach/terraform-rancher2-aws/commit/7b5c454b1c24acfb07e6191fd84458a3c7ce6980))
* bump aws-actions/configure-aws-credentials from 6.2.2 to 6.2.3 ([#181](https://github.com/matttrach/terraform-rancher2-aws/issues/181)) ([88be7c2](https://github.com/matttrach/terraform-rancher2-aws/commit/88be7c20d9fe00ed7e195718c7435afcb75a11b3))
* bump aws-actions/configure-aws-credentials from 6.2.3 to 6.2.4 ([#194](https://github.com/matttrach/terraform-rancher2-aws/issues/194)) ([cc238fa](https://github.com/matttrach/terraform-rancher2-aws/commit/cc238fa06537cd9ace47dc2161bc98ac658ac211))
* bump fossas/fossa-action from 1.9.0 to 2.0.0 ([#168](https://github.com/matttrach/terraform-rancher2-aws/issues/168)) ([f55f9d0](https://github.com/matttrach/terraform-rancher2-aws/commit/f55f9d03c9cc02b63a317f86f317bfe6f8ae0d7c))
* bump integrations/github from 6.8.0 to 6.13.0 in /modules/cluster/node_template ([#182](https://github.com/matttrach/terraform-rancher2-aws/issues/182)) ([63c5aee](https://github.com/matttrach/terraform-rancher2-aws/commit/63c5aeee1ef588f74351580e20c86018cdb434d0))
* bump rancher-eio/read-vault-secrets ([#190](https://github.com/matttrach/terraform-rancher2-aws/issues/190)) ([bc13cd5](https://github.com/matttrach/terraform-rancher2-aws/commit/bc13cd5da69ef1cea83e9878028efc7d62ba712c))
* configure core agentic guidelines, workflows, and rules ([#186](https://github.com/matttrach/terraform-rancher2-aws/issues/186)) ([9c20165](https://github.com/matttrach/terraform-rancher2-aws/commit/9c201653be1e5c65978e4b8a83ad6e796527638a))
* implement execution hooks and planning security ([#187](https://github.com/matttrach/terraform-rancher2-aws/issues/187)) ([44a771c](https://github.com/matttrach/terraform-rancher2-aws/commit/44a771c8a2452160916cd846cad2fdf6d7b47f1a))
* increase test timeout to 4 hours ([#178](https://github.com/matttrach/terraform-rancher2-aws/issues/178)) ([dd09ab5](https://github.com/matttrach/terraform-rancher2-aws/commit/dd09ab59b8ab81ad962860b93516611726d775c5))
* only install colima in darwin systems ([#179](https://github.com/matttrach/terraform-rancher2-aws/issues/179)) ([59dfdec](https://github.com/matttrach/terraform-rancher2-aws/commit/59dfdec02d2ca6bfa0ede0792ec6f31c1dbc55f4))
* reduce parallelism and Go max processors to prevent CPU pinning ([#184](https://github.com/matttrach/terraform-rancher2-aws/issues/184)) ([5794b89](https://github.com/matttrach/terraform-rancher2-aws/commit/5794b89fc4dbc1740cabcbbc0385a848d6221a37))
* refactor test suite ([#174](https://github.com/matttrach/terraform-rancher2-aws/issues/174)) ([07a67ec](https://github.com/matttrach/terraform-rancher2-aws/commit/07a67ec2adac6e5960fc1d920bf6be4c2e8f8391))
* remove release please from container ([#177](https://github.com/matttrach/terraform-rancher2-aws/issues/177)) ([a9416c2](https://github.com/matttrach/terraform-rancher2-aws/commit/a9416c2a449bd7a035fcf1a67d9b6bbc1aefc313))
* rework the workflows to new standards ([#172](https://github.com/matttrach/terraform-rancher2-aws/issues/172)) ([339b737](https://github.com/matttrach/terraform-rancher2-aws/commit/339b737e7a05038357c3b4642f94a96252fbc974))
* test in a matrix ([#199](https://github.com/matttrach/terraform-rancher2-aws/issues/199)) ([5dea169](https://github.com/matttrach/terraform-rancher2-aws/commit/5dea169d86405c3412efca6643ebaec568bab907))
* this fixes a shellcheck error in a temporary script ([#176](https://github.com/matttrach/terraform-rancher2-aws/issues/176)) ([5f6c403](https://github.com/matttrach/terraform-rancher2-aws/commit/5f6c4030e9eae706dfa9fc6580fcfae90fe1e13b))
* update development environment nix configurations ([#185](https://github.com/matttrach/terraform-rancher2-aws/issues/185)) ([0e12e90](https://github.com/matttrach/terraform-rancher2-aws/commit/0e12e90f24175e618c414ce36da96bee38882f24))
* update modules and actions and adjust Rancher version ([#198](https://github.com/matttrach/terraform-rancher2-aws/issues/198)) ([f8208d3](https://github.com/matttrach/terraform-rancher2-aws/commit/f8208d3e49f468e18429c20e93970b5de8fde357))
* use proper import path for release scripts in container ([#175](https://github.com/matttrach/terraform-rancher2-aws/issues/175)) ([57c7cd8](https://github.com/matttrach/terraform-rancher2-aws/commit/57c7cd8b448b31203eee4ce2b86e828829c88644))
